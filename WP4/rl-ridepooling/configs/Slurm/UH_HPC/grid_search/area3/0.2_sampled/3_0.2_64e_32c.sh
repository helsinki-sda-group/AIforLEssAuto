...
srun  --hint=compute_bound python src/tests/gym_test-rs.py --config configs/policy_training/helsinki_updated_areas/area3_sampled_0.2.yaml --total-iters 64 --num-envs 64 --postfix ${SLURM_JOB_ID}_${SLURM_JOB_NAME}
