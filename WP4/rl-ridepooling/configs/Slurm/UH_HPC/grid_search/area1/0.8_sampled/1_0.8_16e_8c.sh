...
srun --cpu-bind=ldoms --hint=compute_bound python src/tests/gym_test-rs.py --config configs/policy_training/helsinki_updated_areas/area1_sampled_0.8.yaml --total-iters 16  --num-envs 16 --postfix ${SLURM_JOB_ID}_${SLURM_JOB_NAME}
