...
srun python src/tests/gym_test-rs.py --config configs/policy_training/helsinki_updated_areas/area1_sampled_0.4.yaml --num-envs 128 --postfix ${SLURM_JOB_ID}_${SLURM_JOB_NAME}
