#!/bin/bash
#SBATCH --job-name="sumo_64envs_32cpus_spawn.log"
...
srun python src/tests/gym_test-rs_multiproc.py --config configs/policy_training/helsinki_updated_areas/area1_sampled_0.4.yaml --num-envs 64 --postfix ${SLURM_JOB_ID}_${SLURM_JOB_NAME}
