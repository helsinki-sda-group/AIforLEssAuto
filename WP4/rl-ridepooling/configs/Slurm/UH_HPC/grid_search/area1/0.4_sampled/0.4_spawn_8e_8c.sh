#!/bin/bash
#SBATCH --job-name="0.4_8e_8c_spawn"
...
srun python src/tests/gym_test-rs_multiproc.py --config configs/policy_training/helsinki_updated_areas/area1_sampled_0.4.yaml --num-envs 8 --postfix ${SLURM_JOB_ID}_${SLURM_JOB_NAME}
