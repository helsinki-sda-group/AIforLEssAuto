#!/bin/bash
#SBATCH --job-name="sumo_31envs_32cpus.log"
...
srun python src/tests/gym_test-rs.py --config configs/policy_training/helsinki_updated_areas/area1_sampled_0.2.yaml --num-envs 31 --postfix ${SLURM_JOB_ID}_${SLURM_JOB_NAME}
