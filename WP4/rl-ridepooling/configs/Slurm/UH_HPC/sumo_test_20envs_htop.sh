#!/bin/bash
#SBATCH --job-name="sumo_test_20envs_htop.log"
...
#SBATCH --extra-node-info=1-1:10:1
#SBATCH --mem=20G
...
srun python src/tests/gym_test-rs.py --config configs/policy_training/helsinki_updated_areas/area1_sampled_0.2.yaml --num-envs 20 --postfix ${SLURM_JOB_ID}_${SLURM_JOB_NAME}
