...
srun --hint=compute_bound singularity exec --bind /usr/lib64 $SIF python src/tests/gym_test-rs.py --config configs/policy_training/helsinki_updated_areas/area1_sampled_0.8.yaml --total-iters 32 --num-envs 32 --postfix ${SLURM_JOB_ID}_${SLURM_JOB_NAME}
