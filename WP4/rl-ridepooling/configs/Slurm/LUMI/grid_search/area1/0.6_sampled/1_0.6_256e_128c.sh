#!/bin/bash
#SBATCH --job-name="1_0.6_256e_128c"
...
srun --hint=compute_bound singularity exec --bind /usr/lib64 $SIF python src/tests/gym_test-rs.py --config configs/policy_training/helsinki_updated_areas/area1_sampled_0.6.yaml --total-iters 256 --num-envs 256 --postfix ${SLURM_JOB_ID}_${SLURM_JOB_NAME}
