#!/bin/bash
#SBATCH --job-name="1_0.4_128e_64c"
...
srun --hint=compute_bound singularity exec --bind /usr/lib64 $SIF python src/tests/gym_test-rs.py --config configs/policy_training/helsinki_updated_areas/area1_sampled_0.4.yaml --total-iters 128 --num-envs 128 --postfix ${SLURM_JOB_ID}_${SLURM_JOB_NAME}
