...
srun --hint=compute_bound singularity exec --bind /usr/lib64 $SIF python src/tests/gym_test-rs.py --config configs/policy_training/helsinki_updated_areas/area2_sampled_0.6.yaml --total-iters 128 --num-envs 128 --postfix ${SLURM_JOB_ID}_${SLURM_JOB_NAME}
