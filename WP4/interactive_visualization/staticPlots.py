...
def main():
    # Scenarios' amount
    scenarios = 4
    EMISSION_FILES = ['simulation_output/emissions_%d.csv' % i for i in range(1,scenarios+1)]
    TELEPORT_FILES = ["simulation_output/teleports_%d.csv" % i for i in range(1,scenarios+1)]
    # Results
